...
//				try {					
//					Update update = HttpUtil.checkVersion(Constant.CHECK_VERSION, null);
//					msg.what = 1;
//					msg.obj = update;
//				} catch (Exception e) {
//					e.printStackTrace();
...
//	 * @param isShowMsg 是否显示提示消息
//	 */
//	public void downloadApp(Context context, final boolean isShowMsg, final String appUrl){
//		this.mContext = context;
//		getCurrentVersion();
//		if(isShowMsg){
//			if(mProDialog == null)
...
//				Message msg = new Message();
//				try {					
//					//Update update = null;//AdsHttpClientUtil.checkVersion(URLS.CHECK_VERSION, null);
//					Update update = new Update();
//					update.setDownloadUrl(appUrl);
//					msg.what = 1;
//					msg.obj = update;
//				} catch (Exception e) {
//					e.printStackTrace();
...
//		public void run() {
//			try {
//				String apkName = "Native_"+(new Date()).getTime()+".apk";//mUpdate.getVersionName()+".apk";
//				String tmpApk = "Native_"+(new Date()).getTime()+".tmp";//  mUpdate.getVersionName()+".tmp";
//				//判断是否挂载了SD卡
//				String storageState = Environment.getExternalStorageState();		
//				if(storageState.equals(Environment.MEDIA_MOUNTED)){
//					savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/LifeYOYO/";
