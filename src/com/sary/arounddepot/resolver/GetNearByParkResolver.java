...
public class GetNearByParkResolver implements BaseResolver{

	@Override
	public String getRequestURL(){
		// TODO Auto-generated method stub
		return Constant.GET_AROUND_PARK;
	}

	@Override
	public BaseData parseData(String content) throws JSONException {
		Log.e("tag","parseData(String content) throws JSONException" );
