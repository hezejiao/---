...
public class MyImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (width > ParkDetailActivity.screenWidth) {
		// 如果图宽大于屏宽，就不用水平居中
		center(false, true);
		} else {
		center(true, true);
	...
	private void arithScaleRate() {
		float scaleWidth = ParkDetailActivity.screenWidth / (float) imageWidth;
		float scaleHeight = ParkDetailActivity.screenHeight / (float) imageHeight;
	...
	public void setImageBitmap(Bitmap bitmap) {
		...
		arithScaleRate();
		//缩放到屏幕大小
		zoomTo(scaleRate,ParkDetailActivity.screenWidth / 2f, ParkDetailActivity.screenHeight / 2f);
	...
	public void layoutToCenter()
	{
		...
		//空白区域宽高
		float fill_width = ParkDetailActivity.screenWidth - width;
		float fill_height = ParkDetailActivity.screenHeight - height;
	...
	protected float getValue(Matrix matrix, int whichValue) {
		...
		mMinZoom =( ParkDetailActivity.screenWidth/2f)/imageWidth;
